...
<a href="http://immediatelistbuildingpro.com" target="_blank">
<img src="http://www.wpsmartapps.com/productBanners/images/468X60.jpg" alt="Immediate List Builing Pro" width="468" height="60" border="0">
</a><br>
<a href="http://www.headerbardomination.com" target="_blank">
<img src="http://www.wpsmartapps.com/productBanners/images/hbdom/468x60.jpg" alt="Header Bar Domination" width="468" height="60" border="0">
</a>
</div>

	<!--Title-->
	<div style="padding-top:1px; padding-bottom:10px;">
		<div style="float:right; width:450px; color:#717171; font-weight:bold; background:#F9F7EC; padding:5px 5px 5px 5px; border:1px dashed #FFFF33;">
Get WEEKLY notifications on how 'bloggers generate <br>traffic and money every MONTH!' 			
...
<form method="post" action="http://www.aweber.com/scripts/addlead.pl">
	...
	<input type="submit" value="Get On The List" style="overflow:visible;padding:5px 10px 6px 7px;    background-color: #5872A7; color:#fff;
		...
		<h3>
			<span style="padding-bottom:0px; color:#E68B01; font-weight:bold;">
				Global RSS Display Configuration
			</span>
		</h3>
	...
	<div class="rfr2b-content">
		<div class="rfr2b-section">
			<!--Start Global Content-->
				...
				<div id="wpsmartapps_help_section" style="display:block; background:#F9F7EC; min-height:150px; border-bottom:1px solid #E4E3DF;border-top:1px solid #E4E3DF; ">
				...
				<li><?php echo $this->rfr2b_img_rightarrow; ?>&nbsp;<a href="http://www.readersfromrss2blog.com/" target="_blank">Header Bar Domination</a></li>
					</ul>					
					</td>
		...
		<form action="" name="rfr2b_global_form" method="post" >
		  ...
		  <h3 class="heading">
			...
			<small style="font-weight:normal; color:#8D8B8B;">If enable, Tag associate with each post will display on your RSS FEED.</small>			</h3>
				...
				<!--STEP 3 :: Feed Item-->					
		  <h3 class="heading">
				<span class="rfr2b_step_indicator rfr2b_step_active">4</span>&nbsp;&nbsp;<input type="checkbox" value="1" disabled="disabled" />
				<span style="color:#999999; font-weight:bold;">&nbsp;&nbsp;Display Latest <input name="rfr2b[noOfComments2display]" type="text" style="width:40px; font-weight:normal;" value="3" disabled="disabled" /> Post Comments</span>&nbsp;&nbsp;<span style="color:#FF3333; font-size:10px;">Only Available On Pro Version</span>&nbsp; <span class="placementLinks"> 
...
<div align="left" style="padding-left:20px;">&nbsp;<i><span style=" border-bottom:1px dashed #0033CC">Click On Check Box If You Wish Not to Show Icons On RSS Feed</span></i></div>
				...
				<textarea name="rfr2b[rfr2b_copyright_notice]" cols="100" rows="3"><?php echo $this->fetch_copyright_notice; ?></textarea>
								&nbsp;&nbsp;
